                ...
                nexusArtifactUploader(
                    ...
                    artifacts: [
                        [artifactId: 'curioushead-root-project',
                         classifier: '',
                         file: 'target/curioushead-root-project-0.0.1.jar',
                         type: 'jar']
                    ]
                )
            }
        ...
        stage("Deploy to Kubernetes") {
            steps {
                sshagent(['k8s-control-1']) {
                    ...
                    script {
                        try {
                            sh 'kubectl delete services spring-curioushead-root-project-service'
                            sh 'kubectl delete deployment spring-curioushead-root-project'
